...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ShoppingListDataExt
    {
        ...
        public static IServiceCollection AddShoppingListDataService(this IServiceCollection services,
            ServiceLifetime serviceLifetime = ServiceLifetime.Scoped)
        {
            ...
            services.Add(new ServiceDescriptor(typeof(IShoppingListService), typeof(ShoppingListService),
                serviceLifetime));
